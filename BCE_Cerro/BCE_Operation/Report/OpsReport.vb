...
Public Class OpsReport
    Private Sub OpsReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub
	Sub ViewDeliveryList()
		Try
			strQuery = "EXEC vw_ops_report @date1 = @date1,
										   @date2 = @date2"
            ...
            dgv_Deliverylist.Columns(0).Visible = False
